...
import { ArrowUpRight, Link2, Megaphone, Pencil, Plus, Trash2 } from "lucide-react";
...
function parseLinks(raw?: string): DashboardLink[] {
  ...
  try {
    ...
    return Array.isArray(parsed)
      ? parsed.filter((l) => l && typeof l.label === "string" && typeof l.url === "string")
      : [];
  } catch {
    return [];
  }
          ...
          <div className="relative flex flex-col gap-6 px-7 py-8 sm:flex-row sm:items-center sm:justify-between">
            {school?.logoUrl && (
              <img
                src={school.logoUrl}
                alt=""
                className="h-16 w-16 rounded-2xl object-contain bg-white/10 p-1.5 border border-white/15 shrink-0"
              />
            )}
    ...
    >
      <DialogTrigger asChild>
        <Button variant="outline" size="sm">
          <Pencil className="h-3.5 w-3.5 mr-1.5" /> Edit landing page
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit public landing page</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          <div className="pt-1">
            ...
            <p className="text-xs text-muted-foreground mb-2">
              Shown as a rotating background on the sign-in landing page. Add more than one for a
              slideshow.
            </p>
            <div className="space-y-2">
              ...
              {images.length === 0 && (
                <p className="text-xs text-muted-foreground">
                  No hero images yet — a default gradient background is used.
                </p>
              )}
            </div>
          </div>
          <div>
            ...
            <Input
              placeholder="Leave blank for the default welcome heading"
              value={heroHeading}
          ...
          <div>
            ...
            <Textarea
              rows={2}
              placeholder="Leave blank for the default subtext"
              value={heroSubtext}
          ...
          <div className="pt-2 border-t">
            ...
            <Input
              placeholder={`Leave blank for "About <school name>"`}
              value={aboutTitle}
          ...
          <div>
            ...
            <Textarea
              rows={4}
              placeholder="Leave blank for the default description"
              value={aboutBody}
...
function DashboardEditor({
  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <Button variant="outline" size="sm">
          <Pencil className="h-3.5 w-3.5 mr-1.5" /> Edit dashboard
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mb-1.5">
              Shown as a full-width banner below the welcome card. Leave blank to use the school
          ...
          <div className="pt-2 border-t">
            ...
            <p className="text-xs text-muted-foreground mb-2">
              Shown on the sign-in screen, before anyone logs in — e.g. a link to your public
              website or admissions page. Leave both fields blank to remove it.
            </p>
            <div className="grid grid-cols-2 gap-3">
              <Input
              ...
              <Input
                placeholder="https://…"
                value={loginButtonUrl}
                onChange={(e) => setLoginButtonUrl(e.target.value)}
              />
            </div>
          </div>
